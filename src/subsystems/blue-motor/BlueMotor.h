...
public:
  ...
  static constexpr double PICKUP_ROOF_45_DEGREE_SETPOINT = 11; // rotations
  static constexpr double ABOVE_ROOF_45_DEGREE_SETPOINT = 13; // rotations
  static constexpr double PLACE_ROOF_45_DEGREE_SETPOINT = 12; // rotations
